...
function updateMainContent(day) {
    ...
    switch (day) {
        ...
        case 'Sexta':
            ...
            break;
        case 'Sábado':
            activities = '<div class="line"><a href="https://totale.rosettastone.com/plan">Rosetta Stone (30min)</a><br/></div><div class="line"> Series Session (40min)<br/></div><div class="line"> Movie Session (extra)</div>';
            break;
        case 'Domingo':
